...
def test_update():
    ...
    source_file = excel_file.SourceFile(
        "workbook_copy.xlsx", "Sheet1", "Sales Code", "Total Qty"
    )
    destination_file = excel_file.DestinationFile(
        "workbook_copy_1.xlsx", "Upload", "ID", "3S"
    )
